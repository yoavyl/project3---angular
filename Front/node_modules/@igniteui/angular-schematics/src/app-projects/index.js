...
function default_1(options) {
    return (tree, _context) => {
        ...
        config.cliVersion = cli_core_1.Util.version(path_1.join(__dirname, "../../package.json"));
        return schematics_1.chain([
            (_tree, context) => {
                context.logger.debug(`Project template: ${options.projTemplate.id}`);
            },
            ...options.projTemplate.templatePaths.map(templatePath => schematics_1.mergeWith(schematics_1.apply(schematics_1.url(cli_core_1.Util.relativePath(__filename, templatePath, true)), [
