...
export declare class IgxGridComponent extends IgxGridBaseDirective implements GridType, OnInit, DoCheck, AfterContentInit, AfterViewInit {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<IgxGridComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<IgxGridComponent, "igx-grid", never, { "groupsExpanded": "groupsExpanded"; "id": "id"; "data": "data"; "groupingExpressions": "groupingExpressions"; "groupingExpansionState": "groupingExpansionState"; "hideGroupedColumns": "hideGroupedColumns"; "dropAreaMessage": "dropAreaMessage"; "showGroupArea": "showGroupArea"; "dropAreaTemplate": "dropAreaTemplate"; }, { "dataPreLoad": "dataPreLoad"; "groupingExpressionsChange": "groupingExpressionsChange"; "groupingExpansionStateChange": "groupingExpansionStateChange"; "onGroupingDone": "onGroupingDone"; }, ["detailTemplate", "groupTemplate", "gridDetailsTemplate", "groupByRowSelectorsTemplates"], ["igx-grid-toolbar", "igx-grid-footer"]>;
}
