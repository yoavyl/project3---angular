...
export declare class IgxDateRangePickerComponent extends PickerBaseDirective implements OnChanges, OnInit, AfterViewInit, OnDestroy, ControlValueAccessor, Validator {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<IgxDateRangePickerComponent, [null, null, null, null, null, null, null, { optional: true; }, { optional: true; }]>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<IgxDateRangePickerComponent, "igx-date-range-picker", never, { "displayMonthsCount": "displayMonthsCount"; "weekStart": "weekStart"; "placeholder": "placeholder"; "doneButtonText": "doneButtonText"; "minValue": "minValue"; "maxValue": "maxValue"; "resourceStrings": "resourceStrings"; "value": "value"; "hideOutsideDays": "hideOutsideDays"; "locale": "locale"; "formatter": "formatter"; "overlaySettings": "overlaySettings"; "displayFormat": "displayFormat"; "inputFormat": "inputFormat"; "outlet": "outlet"; }, { "valueChange": "valueChange"; }, ["label", "pickerActions", "dateSeparatorTemplate", "projectedInputs"], ["igx-date-single", "igx-date-range-start", "igx-date-range-end", "[igxLabel]", "igx-prefix,[igxPrefix]", "igx-suffix,[igxSuffix]", "igx-hint,[igxHint]"]>;
}
